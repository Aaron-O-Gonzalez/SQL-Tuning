...
CREATE INDEX crsCode_deptId_studId_idx ON Course(crsCode, deptId);
CREATE INDEX crsCode_studId ON Transcript(studId, crsCode);
CREATE INDEX crsCode_teach ON Teaching(crsCode);
